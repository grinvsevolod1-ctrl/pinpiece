...
const ROUTES = [
  { from: 'Москва', to: 'Санкт-Петербург', km: '710 км', time: '1 сутки', price: 'от $210' },
  { from: 'Москва', to: 'Казань', km: '820 км', time: '1 сутки', price: 'от $240' },
  { from: 'Москва', to: 'Екатеринбург', km: '1790 км', time: '2 суток', price: 'от $440' },
  { from: 'Москва', to: 'Краснодар', km: '1350 км', time: '2 суток', price: 'от $350' },
  { from: 'Санкт-Петербург', to: 'Нижний Новгород', km: '1080 км', time: '2 суток', price: 'от $300' },
  { from: 'Екатеринбург', to: 'Новосибирск', km: '1520 км', time: '2 суток', price: 'от $400' },
]
