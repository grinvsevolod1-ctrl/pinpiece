...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'Ответственность перевозчика застрахована на сумму до 10 млн ₽. По запросу оформляем дополнительное страхование конкретного груза на его полную стоимость.',
  },
  {
